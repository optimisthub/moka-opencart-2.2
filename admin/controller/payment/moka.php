...
class ControllerPaymentMoka extends Controller
{
    ...
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('payment/moka', 'token=' . $this->session->data['token'], true)
        );
        ...
        $this->response->setOutput($this->load->view('payment/moka', $data));
    }
    ...
    public function transactions()
    {
        ...
        $transactions_total = $this->model_payment_moka->getTotalTransactions($filter_data);
        $transactions = $this->model_payment_moka->getTransactions($filter_data);
    ...
    public function install()
    {
        ...
        $this->model_payment_moka->createTables();
    }
    ...
    public function uninstall()
    {
        ...
        $this->model_payment_moka->dropTables();
    }
    ...
    {
        if (!$this->user->hasPermission('modify', 'payment/moka')) {
